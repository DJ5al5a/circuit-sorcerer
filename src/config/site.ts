...
export const siteConfig = {
  ...
  author: {
    ...
    bio: 'Self-taught infrastructure engineer passionate about self-hosting, automation, and building resilient systems. Dedicated to learning cybersecurity and creating powerful home lab environments.',
    bioExtended: 'I\'m passionate about building robust, self-hosted infrastructure that prioritizes privacy, security, and complete control. From containerized applications to network security, I love exploring the full stack of modern DevOps and cybersecurity practices.',
    avatar: '/circuitsorcerer.png',
